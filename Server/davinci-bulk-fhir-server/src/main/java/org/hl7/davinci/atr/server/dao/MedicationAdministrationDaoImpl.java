...
public class MedicationAdministrationDaoImpl extends AbstractDao implements MedicationAdministrationDao {
	...
	public DafMedicationAdministration getMedicationAdministrationById(int id) {
		List<DafMedicationAdministration> list = getSession().createNativeQuery(
			"select * from medicationadministration where data->>'id' = '"+id+
			"' order by data->'meta'->>'versionId' desc", DafMedicationAdministration.class)
			.getResultList();
			return list.get(0);
	}
	 ...
	 * MedicationAdministration record by id.
	 * 
	...
	public DafMedicationAdministration getMedicationAdministrationByVersionId(int theId, String versionId) {
		return getSession().createNativeQuery(
			"select * from medicationadministration where id = '"+theId+
			"' and data->'meta'->>'versionId' = '"+versionId+"'", 
			DafMedicationAdministration.class).getSingleResult();
	}
	...
	public DafMedicationAdministration createMedicationAdministration(
		...
		DafMedicationAdministration dafMedicationAdministration = new DafMedicationAdministration();
		IParser jsonParser = fhirContext.newJsonParser();;
		dafMedicationAdministration.setData(jsonParser.encodeResourceToString(theMedicationAdministration));
		session.beginTransaction();
		session.save(dafMedicationAdministration);
	...
	public DafMedicationAdministration updateMedicationAdministrationById(int theId,
		...
		DafMedicationAdministration dafMedicationAdministration = new DafMedicationAdministration();
		IParser jsonParser = fhirContext.newJsonParser();
		dafMedicationAdministration.setId(theId);
		dafMedicationAdministration.setData(jsonParser.encodeResourceToString(theMedicationAdministration));
		Session session = sessionFactory.openSession();
		session.beginTransaction();
		session.update(dafMedicationAdministration);
		session.getTransaction().commit();
		session.close();
		return dafMedicationAdministration;
	}
	...
	@Override
	public List<DafMedicationAdministration> getMedicationAdministrationForPatientsBulkData(String patientId, Date start, Date end){
	...
	@SuppressWarnings({"unchecked", "deprecation"})
	@Override
	public List<DafMedicationAdministration> getMedicationAdministrationForBulkData(Date start, Date end){
