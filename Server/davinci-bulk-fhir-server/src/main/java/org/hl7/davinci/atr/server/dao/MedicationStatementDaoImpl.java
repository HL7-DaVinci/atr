...
public class MedicationStatementDaoImpl extends AbstractDao implements MedicationStatementDao {
	...
	public DafMedicationStatement getMedicationStatementById(int id) {
		List<DafMedicationStatement> list = getSession().createNativeQuery(
			"select * from medicationstatement where data->>'id' = '"+id+
	...
	public DafMedicationStatement getMedicationStatementByVersionId(int theId, String versionId) {
		return getSession().createNativeQuery(
			"select * from medicationstatement where data->>'id' = '"+theId+
				"' and data->'meta'->>'versionId' = '"+versionId+"'", DafMedicationStatement.class)
					.getSingleResult();
	}
	...
	@Override
	public DafMedicationStatement createMedicationStatement(
			MedicationStatement theMedicationStatement) {
		Session session = sessionFactory.openSession();
		DafMedicationStatement dafMedicationStatement = new DafMedicationStatement();
		IParser jsonParser = fhirContext.newJsonParser();;
		dafMedicationStatement.setData(jsonParser.encodeResourceToString(theMedicationStatement));
		session.beginTransaction();
		session.save(dafMedicationStatement);
	...
	@Override
	public DafMedicationStatement updateMedicationStatementById(int theId,
			MedicationStatement theMedicationStatement) {
		DafMedicationStatement dafMedicationStatement = new DafMedicationStatement();
		IParser jsonParser = fhirContext.newJsonParser();
		dafMedicationStatement.setId(theId);
		dafMedicationStatement.setData(jsonParser.encodeResourceToString(theMedicationStatement));
		Session session = sessionFactory.openSession();
		session.beginTransaction();
		session.update(dafMedicationStatement);
		session.getTransaction().commit();
		session.close();
		return dafMedicationStatement;
	}
	...
	@Override
    public List<DafMedicationStatement> getMedicationStatementForPatientsBulkData(String patientId, Date start, Date end){
	...
	@SuppressWarnings({"unchecked", "deprecation"})
	@Override
    public List<DafMedicationStatement> getMedicationStatementForBulkData(Date start, Date end){
