...
public class CareTeamDaoImpl extends AbstractDao implements CareTeamDao {
	...
	public DafCareTeam getCareTeamById(int id) {
		List<DafCareTeam> list = getSession().createNativeQuery(
			"select * from careteam where data->>'id' = '"+id+
			"' order by data->'meta'->>'versionId' desc", DafCareTeam.class)
				.getResultList();
		return list.get(0);
	}
	 ...
	 * version of the careTeam record by id.
	 * 
	...
	public DafCareTeam getCareTeamByVersionId(int theId, String versionId) {
		return getSession().createNativeQuery(
			"select * from careteam where data->>'id' = '"+theId+
			"' and data->'meta'->>'versionId' = '"+versionId+"'", DafCareTeam.class)
				.getSingleResult();
	}
	/**
    ...
    /**
     * This method builds criteria for updating
     * the CareTeam by id
     * 
     * @param theId
     * @param theCareTeam
	...
	public DafCareTeam updateCareTeamById(int theId, CareTeam theCareTeam) {
		DafCareTeam dafCareTeam = new DafCareTeam();
		IParser jsonParser = fhirContext.newJsonParser();
		dafCareTeam.setId(theId);
		dafCareTeam.setData(jsonParser.encodeResourceToString(theCareTeam));
		Session session = sessionFactory.openSession();
		session.beginTransaction();
		session.update(dafCareTeam);
    ...
    /**
     * This method builds criteria for careteam creation
     * 
     * @param theCareTeam
     * @return dafCareTeam
     */
	@Override
	public DafCareTeam creatCareTeam(CareTeam theCareTeam) {
		Session session = sessionFactory.openSession();
		DafCareTeam dafCareTeam = new DafCareTeam();
		IParser jsonParser = fhirContext.newJsonParser();;
		dafCareTeam.setData(jsonParser.encodeResourceToString(theCareTeam));
		session.beginTransaction();
		session.save(dafCareTeam);
		session.getTransaction().commit();
		session.close();
		return dafCareTeam;
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<DafCareTeam> getCareTeamForBulkDataRequest(Date start, Date end) {
		@SuppressWarnings("deprecation")
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<DafCareTeam> getCareTeamForPatientsBulkDataRequest(String id, Date start, Date end) {
		@SuppressWarnings("deprecation")
		Criteria criteria = getSession().createCriteria(DafCareTeam.class);
		if(id != null) {
