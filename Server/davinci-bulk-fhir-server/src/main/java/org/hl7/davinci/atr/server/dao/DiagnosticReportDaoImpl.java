...
public class DiagnosticReportDaoImpl extends AbstractDao implements DiagnosticReportDao {
	...
	public DafDiagnosticReport createDiagnosticReport(DiagnosticReport theDiagnosticReport) {
	 ...
	 /**
     * This method builds criteria for updating DiagnosticReport 
     * by id
     * 
     * @param theId
	...
	public DafDiagnosticReport updateDiagnosticReportById(int theId, DiagnosticReport theDiagnosticReport) {
		DafDiagnosticReport dafDiagnosticReport = new DafDiagnosticReport();
		IParser jsonParser = fhirContext.newJsonParser();
		dafDiagnosticReport.setId(theId);
		dafDiagnosticReport.setData(jsonParser.encodeResourceToString(theDiagnosticReport));
		Session session = sessionFactory.openSession();
		session.beginTransaction();
		session.update(dafDiagnosticReport);
		session.getTransaction().commit();
		session.close();
		return dafDiagnosticReport;
	}
	...
	@Override
	public List<DafDiagnosticReport> getDiagnosticReportForPatientsBulkData(String patientId, Date start, Date end){
	...
	@SuppressWarnings({"unchecked", "deprecation"})
	@Override
	public List<DafDiagnosticReport> getDiagnosticReportForBulkData(Date start, Date end){
