...
public class AllergyIntoleranceDaoImpl extends AbstractDao implements AllergyIntoleranceDao {
	...
	public DafAllergyIntolerance getAllergyIntoleranceById(int id) {
		List<DafAllergyIntolerance> list = getSession().createNativeQuery(
				"select * from allergy where data->>'id' = '"+id+"' order by data->'meta'->>'versionId' desc", 
				DafAllergyIntolerance.class)
					.getResultList();
			return list.get(0);
	}
	...
	public DafAllergyIntolerance getAllergyIntoleranceByVersionId(int theId, String versionId) {
		return getSession().createNativeQuery(
				"select * from allergy where id = '"+theId+"' and data->'meta'->>'versionId' = '"+versionId+"'", 
				DafAllergyIntolerance.class).getSingleResult();
	}
     ...
     * @return : allergyIntolerance record
     */
    @Override
	@Transactional
	public DafAllergyIntolerance createAllergyIntolerance(AllergyIntolerance theAllergyIntolerance) {
		Session session = sessionFactory.openSession();
		DafAllergyIntolerance dafAllergyIntolerance = new DafAllergyIntolerance();
		IParser jsonParser = fhirContext.newJsonParser();;
		dafAllergyIntolerance.setData(jsonParser.encodeResourceToString(theAllergyIntolerance));
		session.beginTransaction();
		session.save(dafAllergyIntolerance);
	...
	@Override
	public DafAllergyIntolerance updateAllergyIntoleranceById(int theId, AllergyIntolerance theAllergyIntolerance) {
		DafAllergyIntolerance dafAllergyIntolerance = new DafAllergyIntolerance();
		IParser jsonParser = fhirContext.newJsonParser();
		dafAllergyIntolerance.setId(theId);
		dafAllergyIntolerance.setData(jsonParser.encodeResourceToString(theAllergyIntolerance));
		Session session = sessionFactory.openSession();
		session.beginTransaction();
		session.update(dafAllergyIntolerance);
		session.getTransaction().commit();
		session.close();
		return dafAllergyIntolerance;
	}
	...
	@Override
	public List<DafAllergyIntolerance> getAllergyIntoleranceForBulkData(Date start, Date end) {
	...
	@SuppressWarnings({"unchecked", "deprecation"})
	@Override
	public List<DafAllergyIntolerance> getAllergyIntoleranceForPatientsBulkData(String patientId, Date start,
			Date end) {
		Criteria criteria = getSession().createCriteria(DafAllergyIntolerance.class, "allergyIntolerance");
		if(patientId != null) {
